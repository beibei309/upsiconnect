...
<body class="antialiased">
    <div x-data="{ 
            ...
            <div class="max-w-7xl mx-auto">
                <div class="text-center">
                    ...
                    <p class="text-xl md:text-2xl text-indigo-100 mb-8 max-w-3xl mx-auto">
                        'Student to Community' is the premier platform connecting UPSI students with peer-to-peer services. 
        ...
        <section id="features" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-bold text-upsi-dark mb-4">Why Choose S2U?</h2>
        ...
        <section id="how-it-works" class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How S2U Works</h2>
