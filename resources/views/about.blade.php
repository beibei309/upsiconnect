                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-600 leading-relaxed mb-8">
                            S2U is the premier platform connecting UPSI students with peer-to-peer services. Find tutoring, design help, coding assistance, and more from your fellow students.
                        </p>
                        @auth
...
<!-- How It Works Section -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            All of S2U's services are thoroughly screened to ensure they are legitimate. When you log in, you'll only find high-quality opportunities from verified UPSI students—no scams, junk listings, or unreliable providers.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Use advanced search filters to find services that match your needs, schedule, and budget. Save searches, track requests, and follow providers to stay updated on new services.
                        </p>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            Get guidance with tutorials, guides, articles, and more, all designed to help you get the most out of our platform and succeed academically.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-gray-600 text-lg leading-relaxed space-y-4">
                        <p>
                            S2U was created in 2024 to provide a trusted, more effective, friendly, and overall better way 
                            to find peer-to-peer services among UPSI students.
                        </p>
                        <p>
                            We were founded by students after they had been looking for reliable academic help and creative 
                            services. They realized that millions of others were just as frustrated by the lack of trust, 
                            scams, and inefficiencies when searching for help, so they decided to create the solution everyone 
                            was looking for.
                        </p>
                        <p>
                            It wasn't our original intention, but somehow S2U has become a leader in the student services 
                            movement that's currently transforming how UPSI students connect and help each other. We continue 
                    ...
                    <div>
                        <div class="story-image-placeholder">
                            <span>Students Collaborating Image</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="tab-buttons">
                    <button @click="activeTab = 'seekers'" 
                            :class="activeTab === 'seekers' ? 'active' : ''"
                            class="tab-btn">
                        For Service Seekers
                    </button>
                    <button @click="activeTab = 'providers'" 
                            :class="activeTab === 'providers' ? 'active' : ''"
                            class="tab-btn">
        ...
        <section class="py-20 px-4 sm:px-6 lg:px-8 gradient-bg">
            <div class="max-w-4xl mx-auto text-center">
                ...
                @auth
                    <a href="{{ route('search.index') }}" class="bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-50 transition inline-block">
                        Find Your Next Service!
                    </a>
                @else
                    <a href="{{ route('register') }}" class="bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-50 transition inline-block">
                        Find Your Next Service!
                    </a>
                @endauth
            </div>
