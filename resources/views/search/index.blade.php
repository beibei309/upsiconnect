    ...
    <head>
        ...
        <title>{{ config('app.name', 'S2U') }}</title>
            ...
            <div class="pt-24 pb-10">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mb-10">
                        ...
                        <p class="text-upsi-text-primary mt-2" style="color: #757574">We have {{ $services->filter(fn($service) => $service->user->is_available)->count() }} services online ready to help you.</p>
                    </div>
                    ...
                    <div class="space-y-6">
                        @if ($services->count() > 0)
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                @foreach ($services as $service)
                                    <div
                                        class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow group flex flex-col h-full">
                                        <!-- Student Header -->
                                        <div class="p-4 pb-3">
                                            <div class="flex items-start justify-between">
                                                <div class="flex items-center space-x-2">
                                                    <a href="{{ route('students.profile', $service->user) }}"
                                                        class="block group/avatar">
                                        ...
                                        <div class="px-4 pb-3 flex-grow">
                                            <a href="{{ route('student-services.show', $service) }}"
                                                class="font-medium text-upsi-dark mb-1 text-sm group-hover:text-indigo-600 hover:underline">{{ Str::limit($service->title, 30) }}</a>
                                            <p class="text-xs text-upsi-text-primary mb-2 line-clamp-2">
                                            ...
                                            <div class="mb-2 min-h-[20px]" >
                                                @if ($service->category)
                                                    <div class="flex flex-wrap gap-1">
                                                        <span
                                                            class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-800"  style="color: {{ $category->color }};">
                                                ...
                                                <div class="flex space-x-2">
                                                    @if ($service->status === 'available')
                                                        <a href="{{ route('chat.request', ['user' => $service->user->id, 'service' => $service->title]) }}"
                                                            ...
                                                            Contact Provider
                                                            <svg class="w-4 h-4 ml-1.5" fill="none"
                        ...
                        @else
                            ...
                            <div class="text-center py-12">
                                ...
                                <p class="mt-2 text-upsi-text-primary">Try adjusting your search criteria or browse all
