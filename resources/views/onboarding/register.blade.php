    ...
    <div class="bg-base-100 p-6 sm:p-8">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2">Choose your path to get started</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="card bg-white border border-gray-200 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="text-gray-600">Register with your UPSI identity for trusted student services.</p>
                        <div class="space-y-2 text-sm text-gray-500">
                            <div class="flex items-center"><span class="badge badge-sm" style="background-color:#D4AF37;color:#1F2937;">Gold</span><span class="ml-2">Verified student badge</span></div>
                ...
                <div class="card bg-white border border-gray-200 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="text-gray-600">Register as a community user to request and review student services.</p>
                        <div class="space-y-2 text-sm text-gray-500">
            ...
            <div class="mt-10">
                <div class="alert" style="background-color:#F3F4F6;color:#1F2937;">
                    <div>
                        <span class="badge mr-2" style="background-color:#D4AF37;color:#1F2937;">Trust</span>
