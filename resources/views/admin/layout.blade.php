...
<body class="bg-gray-50 font-sans antialiased text-gray-900">
    ...
    <button onclick="toggleSubMenu('serviceMenu', 'serviceArrow')"
            class="w-full flex items-center justify-between px-4 py-3 rounded-lg transition-colors
            {{ request()->routeIs('admin.faqs.*') || request()->routeIs('admin.services.*') ? 'text-blue-700 font-semibold bg-blue-50' : 'text-gray-600 hover:bg-gray-100 hover:text-blue-600' }}">
        <div class="flex items-center gap-3">
        ...
        <svg id="serviceArrow" class="w-4 h-4 transition-transform {{ request()->routeIs('admin.faqs.*') || request()->routeIs('admin.services.*') ? 'rotate-90' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
    </button>
    
    <ul id="serviceMenu" class="pl-11 mt-1 space-y-1 {{ request()->routeIs('admin.faqs.*') || request()->routeIs('admin.services.*') ? '' : 'hidden' }}">
        <li>
            <a href="{{ route('admin.faqs.index') }}" class="block px-4 py-2 text-sm rounded-lg hover:bg-blue-50 hover:text-blue-600 {{ request()->routeIs('admin.faqs.*') ? 'text-blue-600 font-semibold' : 'text-gray-600' }}">Categories</a>
        </li>
        <li>
            <a href="{{ route('admin.services.index') }}" class="block px-4 py-2 text-sm rounded-lg hover:bg-blue-50 hover:text-blue-600 {{ request()->routeIs('admin.services.*') ? 'text-blue-600 font-semibold' : 'text-gray-600' }}">All Services</a>
        </li>
    </ul>
</li>
