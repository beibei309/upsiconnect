...
<td class="px-6 py-4 text-right">
    <div class="flex justify-end gap-3">
        ...
        {{-- BAN / UNBAN --}}
        @if ($student->is_suspended)
            <form action="{{ route('admin.students.unban', $student->id) }}" method="POST" class="inline">
                @csrf
                <button type="submit"
      ...
      action="{{ route('admin.students.delete', $student->id) }}"
      method="POST"
      class="inline">
    @csrf
    @method('DELETE')
    ...
    <div id="banModal"
        ...
        <div class="bg-white w-full max-w-md p-6 rounded-lg shadow-xl">
            ...
            <div class="mt-5 flex justify-end gap-3">
                <button onclick="closeBanModal()" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded">
                    Cancel
                </button>

                <button onclick="submitBan()" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded">
                    Confirm Ban
                </button>
            </div>
