<x-app-layout>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    ...
                                    @if($serviceRequest->selected_dates)
                                    <div class="sm:col-span-2">
                                        <label class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Requested Date</label>
                                        <div class="flex items-center gap-2 mt-1 text-gray-800 font-medium">
                            ...
                            <div>
                                ...
                                <div class="bg-white rounded-xl border border-gray-200 p-5 flex gap-4 items-start hover:shadow-md transition-shadow">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                                ...
                                <div class="mb-6">
                                    <span class="text-xs font-semibold text-indigo-500 mb-2 block">Service Provider</span>
                                ...
                                <div>
                                    <span class="text-xs font-semibold text-blue-500 mb-2 block">Client (Requester)</span>
                                    <div class="flex items-center gap-3">
    ...
    <script>
        // Copy your JS functions here (updateRequestStatus, openReviewModal, etc.)
        // Ensure they match the IDs in this new layout.
        
        async function updateRequestStatus(requestId, action) {
            // Using SweetAlert for nicer confirms
            ...
            // Map actions to routes (Adjust URLs to match your web.php)
            const endpoints = {
        ...
        document.getElementById('reviewForm').addEventListener('submit', async function(e) {
            e.preventDefault();
            // ... (Your existing review submission logic) ...
            // Just copy the fetch logic from your previous index file
             const formData = new FormData(this);
             // ... fetch('/reviews', ...)
             // For brevity, assuming you paste the working JS here.
             try {
