<x-app-layout>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="relative bg-gradient-to-r from-gray-400 to-gray-500 px-8 py-10 text-white">
                    <div
                        ...
                        <div>
                            <span
                                class="inline-block px-3 py-1 mb-3 text-xs font-bold tracking-wider uppercase bg-white/20 rounded-full">
                        ...
                        <div class="px-5 py-2 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 shadow-sm">
                            ...
                            <div class="text-xl font-bold capitalize flex items-center gap-2 mt-1">
                                <span
                                    class="w-3 h-3 rounded-full {{ $serviceRequest->status === 'pending' ? 'bg-yellow-400' : ($serviceRequest->status === 'in_progress' ? 'bg-blue-400' : ($serviceRequest->status === 'completed' ? 'bg-green-400' : 'bg-red-400')) }}"></span>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div>
                                ...
                                <div
                                    class="bg-gray-50 rounded-xl p-6 border border-gray-100 grid grid-cols-1 sm:grid-cols-2 gap-6">

                                    <div>
                                        <label
                                            class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Package
                                            Selected</label>
                                    ...
                                    <div>
                                        <label
                                            class="text-xs font-semibold text-gray-400 uppercase tracking-wide">From</label>
                                    ...
                                    <div class="sm:col-span-2">
                                        <label
                                            class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Requested
                                            Dates</label>
                                    ...
                                    @if ($serviceRequest->status === 'rejected' && $serviceRequest->rejection_reason)
                                        <div class="sm:col-span-2">
                                            ...
                                            <div
                                                class="mt-2 p-4 bg-red-50 rounded-lg border border-red-100 text-red-800">
                                                <div class="flex gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm mt-1">
                                                            "{{ $serviceRequest->rejection_reason }}"</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @if ($serviceRequest->status == 'completed')
                                        <div class="sm:col-span-2 mt-4">
                                            <label
                                                class="text-xs font-semibold text-gray-400 uppercase tracking-wide">Job
                                                Timeline</label>
                                            ...
                                            <div class="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                ...
                                                <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                                                    <span
                                                        class="block text-xs text-blue-400 uppercase font-bold">Accepted</span>
                                                    <span class="font-medium text-gray-700 text-sm">
                                                        @if ($serviceRequest->accepted_at)
                                                            {{ $serviceRequest->accepted_at->format('d M, h:i A') }}
                                                        @else
                                                            -
                                                        @endif
                                                    </span>
                                                ...
                                                <div class="p-3 bg-yellow-50 rounded-lg border border-yellow-100">
                                                    <span
                                                        class="block text-xs text-yellow-500 uppercase font-bold">Started
                                                        Work</span>
                                                    <span class="font-medium text-gray-700 text-sm">
                                                        @if ($serviceRequest->started_at)
                                                            {{ $serviceRequest->started_at->format('d M, h:i A') }}
                                                        @else
                                                            <span class="text-gray-400 italic text-xs">No record</span>
                                                        @endif
                                                    </span>
                                                </div>
                                    ...
                                    <a href="{{ route('services.details', $service->id) }}"
                                        ...
                                        <div>
                                            <h4
                                                ...
                                                {{ $service->title }}</h4>
                                            <span
                                                class="inline-flex mt-1 items-center px-2 py-0.5 rounded text-xs font-medium bg-indigo-50 text-indigo-700">
                        ...
                        <div class="space-y-8">
                            <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                                <h3
                                    class="text-xs font-bold text-gray-400 uppercase tracking-wide mb-6 border-b border-gray-100 pb-2">
                                    People Involved
                                </h3>

                                {{-- 1. Service Seller (Provider) --}}
                                <div class="mb-6">
                                    <span class="text-xs font-semibold text-indigo-500 mb-2 block">Service
                                        Seller</span>
                                    {{-- ADDED: A tag wrapping the content --}}
                                    <a href="{{ route('students.profile', $serviceRequest->provider->id) }}"
                                        class="flex items-center gap-3 p-2 -ml-2 rounded-lg hover:bg-gray-50 transition-colors group">
                                        <img src="{{ $serviceRequest->provider->profile_photo_path ? asset('storage/' . $serviceRequest->provider->profile_photo_path) : 'https://ui-avatars.com/api/?name=' . urlencode($serviceRequest->provider->name) }}"
                                            class="w-10 h-10 rounded-full border border-gray-200 group-hover:border-indigo-200">
                                        <div>
                                            <p
                                                class="text-sm font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">
                                                {{ $serviceRequest->provider->name }}
                                                <span class="text-gray-300 text-[10px] ml-1">↗</span>
                                            </p>
                                            <div class="flex items-center text-xs text-yellow-500">
                                                ...
                                                {{-- Assuming you have a helper or relation for average_rating, otherwise calculate it --}}
                                                <span class="ml-1 text-gray-600">
                                                    {{ number_format(\App\Models\Review::where('reviewee_id', $serviceRequest->provider->id)->avg('rating') ?? 0, 1) }}
                                                </span>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('profile.public', $serviceRequest->requester->id) }}"
                                        class="flex items-center gap-3 p-2 -ml-2 rounded-lg hover:bg-gray-50 transition-colors group">
                                        <img src="{{ $serviceRequest->requester->profile_photo_path ? asset('storage/' . $serviceRequest->requester->profile_photo_path) : 'https://ui-avatars.com/api/?name=' . urlencode($serviceRequest->requester->name) }}"
                                            class="w-10 h-10 rounded-full border border-gray-200 group-hover:border-blue-200">
                                        <div>
                                            <p
                                            ...
                                            <div class="flex items-center text-xs text-yellow-500">
                                                ...
                                                <span class="ml-1 text-gray-600">
                                                    {{ number_format(\App\Models\Review::where('reviewee_id', $serviceRequest->requester->id)->avg('rating') ?? 0, 1) }}
                                                </span>
                                            </div>
                                        </div>
                                    </a>
                            ...
                            <div class="bg-gray-50 rounded-xl border border-gray-200 p-6">
                                <h3 class="text-xs font-bold text-gray-400 uppercase tracking-wide mb-4">Available
                                    Actions</h3>
                                <div class="space-y-3">

                                    @php
                                        $contactPhone = $isProvider
                                            ? $serviceRequest->requester->phone
                                    ...
                                    @if ($isProvider && $serviceRequest->isPending())
                                        <button onclick="updateRequestStatus({{ $serviceRequest->id }}, 'accept')"
                                            class="w-full py-2.5 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 shadow-sm transition">Accept
                                            Request</button>
                                        <button onclick="updateRequestStatus({{ $serviceRequest->id }}, 'reject')"
                                            class="w-full py-2.5 bg-white border border-red-200 text-red-600 rounded-lg font-semibold hover:bg-red-50 transition">Reject
                                            Request</button>
                                    @endif

                                    @if ($isProvider && $serviceRequest->isAccepted())
                                        <button
                                            onclick="updateRequestStatus({{ $serviceRequest->id }}, 'in-progress')"
                                            class="w-full py-2.5 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 shadow-sm transition">Start
                                            Work</button>
                                    @endif

                                    @if ($isProvider && $serviceRequest->isInProgress())
                                        <button onclick="updateRequestStatus({{ $serviceRequest->id }}, 'complete')"
                                            class="w-full py-2.5 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 shadow-sm transition">Mark
                                            as Completed</button>
                                    @endif
                                    ...
                                    @if (
                                        $isRequester &&
                                            ...
                                            !$serviceRequest->reviews()->where('reviewer_id', auth()->id())->exists())
                                        <button onclick="openReviewModal({{ $serviceRequest->id }}, '')"
                                            class="w-full py-2.5 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 shadow-sm transition">Leave
                                            a Review</button>
                                    @endif
    ...
    <div id="reviewModal"
        ...
        <div
            class="relative top-20 mx-auto p-0 border-0 w-full max-w-md shadow-2xl rounded-2xl bg-white overflow-hidden">
            <div class="bg-indigo-600 px-6 py-4 flex justify-between items-center">
                <h3 class="text-lg font-bold text-white">Rate Your Experience</h3>
                <button onclick="closeReviewModal()" class="text-white/80 hover:text-white"><svg class="w-6 h-6"
            ...
            <div class="p-6">
                <form id="reviewForm" class="space-y-6">
                    ...
                    <div class="text-center">
                        <label class="block text-sm font-medium text-gray-700 mb-2">How would you rate this
                            service?</label>
                        <div class="flex justify-center gap-2">
                            @for ($i = 1; $i <= 5; $i++)
                                <button type="button" onclick="setRating({{ $i }})"
                                    class="star-button text-4xl text-gray-300 hover:text-yellow-400 transition-colors focus:outline-none">★</button>
                            @endfor
                        </div>
                    ...
                    <div class="flex gap-3">
                        <button type="button" onclick="closeReviewModal()"
                            class="flex-1 px-4 py-2.5 border border-gray-300 rounded-xl text-gray-700 font-semibold hover:bg-gray-50 transition">Cancel</button>
                        <button type="submit"
                            class="flex-1 px-4 py-2.5 bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition">Submit
                            Review</button>
                    </div>
                </form>
            </div>
    ...
    <script>
        async function updateRequestStatus(requestId, action) {
            ...
            let bodyData = {}; // Data to send to server
            ...
            if (action === 'reject') {
                ...
                // If user clicked cancel, stop the function
                if (!reason) return;
            ...
            // --- HANDLING FOR ACCEPT/START/COMPLETE ---
            else {
                const result = await Swal.fire({
            ...
            try {
                const response = await fetch(endpoints[action], {
                    ...
                    // We convert the bodyData object (which contains rejection_reason if applicable) to JSON
