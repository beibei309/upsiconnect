    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="sent-content" class="tab-content">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-medium mb-4">Your Service Requests</h3>
            ...
            <div id="received-content" class="tab-content hidden">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-medium mb-4">Service Requests for You</h3>
                                                ...
                                                @if($request->offered_price)
                                                    <p class="text-sm text-gray-700 mb-2">
                                                        ...
                                                        <span class="text-xs text-gray-500">
                                                            (Your price: RM {{ number_format($request->studentService->price, 2) }})
                                                        </span>
                                                    </p>
                                                @endif
