                ...
                <div class="mt-6 border-b border-gray-200">
                    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                        <a href="{{ route('services.apply') }}"
                            class="whitespace-nowrap py-4 px-1 border-b-2 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">Apply
                            for Services</a>
                        <a href="{{ route('services.create') }}"
                            class="whitespace-nowrap py-4 px-1 border-b-2 text-sm font-medium border-indigo-600 text-indigo-600">Add
                            New Service</a>
                    </nav>
                </div>
            </div>
                ...
                <form id="createServiceForm" action="{{ route('services.store') }}" method="POST"
                    ...
                    <div>
                        ...
                        <input type="file" id="image" name="image" accept="image/*"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors">
                        <p class="text-sm text-gray-500 mt-1">Upload an image representing your service (optional).</p>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Provide a detailed description to help potential
                                clients
                                understand your service</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="suggested_price" name="suggested_price" min="0"
                                    step="0.01"
                            ...
                            <p class="text-sm text-gray-500 mt-1">Set a suggested price for your service. This can be
                                negotiated with clients.</p>
                        </div>
